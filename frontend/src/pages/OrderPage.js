...
const OrderPage = ({ match, history }) => {
	...
	useEffect(() => {
		const addScript = async () => {
			...
			script.src = `https://www.paypal.com/sdk/js?client-id=AWhBNO25pvW1Hag0RAkwU68hKb8-tlJ--Bcoqc_wh1SSq8Sb8mhcj83srWuJ0qcRNCsC1l5t5CY4BkAf&currency=INR&disable-funding=credit,card`;
												...
												<ListGroup.Item>
													...
													{!SDKReady ? (
														...
														<PayPalButton
															...
															currency='USD'
															// converting USD to USD, as paypal cannot support USD
															amount={Number(
																order.totalPrice /
																	72
															).toFixed(2)}
